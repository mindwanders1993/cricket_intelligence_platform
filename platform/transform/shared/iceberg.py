...
#
# Usage:
#   from platform.transform.shared.iceberg import IcebergCatalogManager
...
from platform.common.contracts.enums import Layer, SchemaChangeType
from platform.common.exceptions import IcebergError, SnapshotError, TableNotFoundError
from platform.common.logging import get_context, get_logger
...
class IcebergCatalogManager:
    ...
    def __init__(
        ...
        from platform.transform.shared.readers import _build_pyiceberg_catalog_props
